 ...
 */
final class Version20240203183510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, nom_annonce VARCHAR(255) NOT NULL, type_annonce VARCHAR(255) NOT NULL, mots_cles_annonce LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', dates_annonce LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', disponibilite VARCHAR(50) NOT NULL, est_rendu TINYINT(1) NOT NULL, est_en_litige TINYINT(1) NOT NULL, image_annonce VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
