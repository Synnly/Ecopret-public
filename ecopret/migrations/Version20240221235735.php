 ...
 */
final class Version20240221235735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, prestataire_id INT NOT NULL, nom_annonce VARCHAR(255) NOT NULL, disponibilite VARCHAR(50) NOT NULL, est_rendu TINYINT(1) NOT NULL, est_en_litige TINYINT(1) NOT NULL, image_annonce VARCHAR(255) DEFAULT NULL, INDEX IDX_F65593E5BE3DB2B7 (prestataire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE carte_credit (id INT AUTO_INCREMENT NOT NULL, numero_carte VARCHAR(16) NOT NULL, date_expiration DATE NOT NULL, code_cvv VARCHAR(3) NOT NULL, nom_carte VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE compte (id INT AUTO_INCREMENT NOT NULL, carte_credit_id INT DEFAULT NULL, nom_compte VARCHAR(255) NOT NULL, prenom_compte VARCHAR(255) DEFAULT NULL, mot_de_passe_compte VARCHAR(255) NOT NULL, adresse_mail_compte VARCHAR(255) NOT NULL, reset_token VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_CFF652602935ED8E (carte_credit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE annonce ADD CONSTRAINT FK_F65593E5BE3DB2B7 FOREIGN KEY (prestataire_id) REFERENCES prestataire (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce DROP FOREIGN KEY FK_F65593E5BE3DB2B7');
