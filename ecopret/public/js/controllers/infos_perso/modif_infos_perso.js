function afficherCacherMdp(){
    ...
    document.getElementById('informations_personnelles_form_motDePasseCompte').type = (document.getElementById('informations_personnelles_form_motDePasseCompte').type == 'text') ? 'password' : 'text';
