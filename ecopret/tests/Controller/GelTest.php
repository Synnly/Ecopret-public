...
class GelTest extends WebTestCase
{
    ...
    public function testPageAccessibleNonConnecte()
    {
        ...
        $crawler = $client->request('GET', '/gel');
    ...
    public function testErreurDatesIncorrectes()
    {
        $client = static::createClient();
        // Deplacement vers la page de creation de compte
        $client->request('GET', '/register');
        ...
        $crawler = $client->submitForm("Enregistrer >", [
            'gel_compte_form[deb]' => '2024-02-21',
            'gel_compte_form[fin]' => '2024-02-20',
        ]);

        // Confirmation
        $crawler->selectButton('Enregistrer >');

        $this->assertAnySelectorTextSame("li", "This value should be greater than or equal to Feb 21, 2024, 12:00 AM.", "Gel d'un compte avec fin < deb possible");
